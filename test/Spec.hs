...
import Problem7 (solution)

main :: IO ()
main = hspec $ do
  describe "Problems" $ do
    it "7: The sixth prime should be 13" $ do
      Problem7.solution 6 `shouldBe` 13
    it "6: The Sum square difference of the first 10 natural numbers should be 2640" $ do
